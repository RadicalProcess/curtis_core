...
namespace rp::curtis
{
    ...
    TEST_F(UnitTest_Polarity, addListener_positive)
    {
    ...
    TEST_F(UnitTest_Polarity, addListener_positive_no_notification)
    {
        auto&& polarity = Polarity();
        polarity.addListener(&polarityListenerMock_);
    ...
    TEST_F(UnitTest_Polarity, addListener_negative)
    {
        auto&& polarity = Polarity();
        polarity.addListener(&polarityListenerMock_);
